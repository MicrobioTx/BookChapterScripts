#' Normalized gene family abundances in the 
#' NLIBD dataset (Franzosa et al., 2019).
#' 
#' Normalized gene family abundance used for 
#' MelonnPan validation (Mallick et al., 2019).
#'
#' @docType data
#'
#' @usage data(melonnpan.test.data)
#'
#' @format A data frame of normalized gene familty abundances, 
#' as described in Mallick et al. (2019), with subjects in rows and 
#' UniRef90 IDs in columns.
#' 
